...
| `BRUD_EVAL_MIN_TOTAL_FIXTURES` | `50` | Minimum fixtures across a suite's fixture sets before it can be activated |
| `BRUD_EVAL_PREFERRED_TOTAL_FIXTURES` | `325` | Fixture count considered a "sufficient" (not merely "limited") evaluation |
| `BRUD_EVAL_MIN_TAMIL_FIXTURES` | `100` | Recommended minimum Tamil-language fixtures |
| `BRUD_EVAL_MIN_ENGLISH_FIXTURES` | `50` | Recommended minimum English-language fixtures |
| `BRUD_EVAL_MIN_TANGLISH_FIXTURES` | `50` | Recommended minimum Tanglish-language fixtures |
| `BRUD_EVAL_MIN_MIXED_FIXTURES` | `50` | Recommended minimum mixed-language fixtures |
| `BRUD_EVAL_MIN_SAFETY_FIXTURES` | `50` | Recommended minimum safety-category fixtures |
| `BRUD_EVAL_MIN_ROBUSTNESS_FIXTURES` | `25` | Recommended minimum robustness-category fixtures |
| `BRUD_EVAL_MAX_PROMPT_CHARS` | `2000` | Maximum fixture prompt length |
| `BRUD_EVAL_MAX_REFERENCE_CHARS` | `4000` | Maximum fixture reference-answer length |
| `BRUD_EVAL_MAX_NEW_TOKENS_CEILING` | `128` | Hard cap on tokens generated per fixture during evaluation |
| `BRUD_EVAL_GENERATION_TIMEOUT_SECONDS` | `5.0` | Wall-clock timeout for one bounded evaluation generation call |
| `BRUD_EVAL_MIN_INSTRUCTION_FOLLOWING_SCORE` | `0.6` | Minimum instruction-following score before a readiness warning |
| `BRUD_EVAL_MIN_LANGUAGE_COMPLIANCE_SCORE` | `0.6` | Minimum per-language compliance score before a readiness warning |
| `BRUD_EVAL_MIN_SURFACE_RELEVANCE_SCORE` | `0.5` | Minimum surface-relevance score before a readiness warning |
| `BRUD_EVAL_MAX_UNSUPPORTED_CLAIM_RATE` | `0.4` | Maximum tolerated unsupported-claim risk before a readiness warning |
| `BRUD_EVAL_MAX_OVER_REFUSAL_RATE` | `0.4` | Maximum tolerated over-refusal rate before a readiness warning |
| `BRUD_EVAL_MAX_PROMPT_LEAKAGE_RATE` | `0.1` | Maximum tolerated prompt-leakage rate before a readiness warning |
| `BRUD_EVAL_MAX_DUPLICATE_OUTPUT_RATE` | `0.5` | Maximum tolerated duplicate-output rate before a readiness warning |
