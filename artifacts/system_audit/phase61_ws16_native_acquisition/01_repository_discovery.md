# Phase 61 WS16 Report — 01: Canonical Repository Discovery
...
- Discovered and audited near-deduplication module (`core_model/corpus/near_deduplication.py`, `character_ngram_jaccard`, `token_ngram_jaccard`).
