export const menuItems = ['Overview', 'System', 'Datasets', 'Documents', 'Core Model', 'Training', 'Evaluation', 'Model Registry', 'Chat Testing', 'Feedback', 'Admin Assistant', 'Audit Logs', 'Settings']
...
export default function Sidebar({ active, open, onSelect, onClose }) {
  return (
    <aside className={`sidebar ${open ? 'open' : ''}`}>
      ...
      <div className="phase-tag">Phase 5 · Document extraction</div>
    </aside>
  )
}
